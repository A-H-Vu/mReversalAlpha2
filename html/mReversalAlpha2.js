...
let expName = 'mReversalAlpha2';  // from the Builder filename that created this script
...
function trials2LoopBegin(thisScheduler) {
  ...
  trials2 = new TrialHandler({
    psychoJS: psychoJS,
    nReps: 90, method: TrialHandler.Method.SEQUENTIAL,
    extraInfo: expInfo, originPath: undefined,
    trialList: undefined,
...
function trial2RoutineEnd(trials) {
  return function () {
    ...
    if (typeof trial2Skip.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('trial2Skip.rt', trial2Skip.rt);
        routineTimer.reset();
        }
...
function instructions3RoutineEnd(trials) {
  return function () {
    ...
    psychoJS.experiment.addData('instr3Resp.keys', instr3Resp.keys);
    if (typeof instr3Resp.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('instr3Resp.rt', instr3Resp.rt);
        routineTimer.reset();
        }
...
function trial3RoutineEnd(trials) {
  return function () {
    ...
    if (typeof trial3Skip.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('trial3Skip.rt', trial3Skip.rt);
        routineTimer.reset();
        }
